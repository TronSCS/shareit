...
contract PlaceIt is owned, TokenTR20 {
    ...
    event PixelPurchased(address indexed byer, bytes4[] pixelPositionArray, bytes3[] colorArray, uint256 timestamp);
     ...
     */
      ...
      */
     function buyPixels(bytes4[] memory pixelPositionArray, bytes3[] memory colorArray) payable public returns(bool){
