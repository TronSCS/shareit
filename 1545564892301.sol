...
contract PlaceIt is owned, TokenTR20 {
     ...
     */
      ...
      */
     function buyPixels(bytes4[] memory pixelPositionArray, bytes6[] memory colorArray) payable public returns(string){
         
         if(pixelPositionArray.length > 0, 'Buyer must purchase at least one position');
