...
contract TokenTR20 {
    ...
    constructor (
        ...
        balanceOf[foundersAddress] = totalSupply * 80/1000;     // 8% to founder address
        balanceOf[developersAddress] = totalSupply *70/1000;    // 7% to developer address
        balanceOf[maintainanceAddress] = totalSupply *120/1000; // 12% to maintainance address
        balanceOf[charityAddress] = totalSupply *30/1000;       // 3% to charity address
        ...
        emit Transfer(address(0), charityAddress, totalSupply *30/1000);
    }
