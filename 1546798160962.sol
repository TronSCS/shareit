...
contract TokenTR20 {
    ...
    constructor (
        ...
        balanceOf[address(this)] = totalSupply * 700/1000;      // 70% will remain in contract
        ...
        emit Transfer(address(0), address(this), totalSupply * 700/1000);
        emit Transfer(address(0), foundersAddress, totalSupply * 80/1000);
        emit Transfer(address(0), developersAddress, totalSupply *70/1000);
        emit Transfer(address(0), maintainanceAddress, totalSupply *120/1000);
    }
...
contract PlaceIt is owned, TokenTR20 {
    ...
    mapping(uint256=>address) pixelDimensionToUsers;    //Mapping for pixes dimension to users
    mapping(uint256=>address) pixelColorToUsers;        //Mapping for pixes color to users
    ...
    uint256[] internal pixelDimensionToUsersTemp;       //Temporary Array which holds all the pixels dimension purchased
    ...
    event PixelPurchased(address indexed byer, uint256 pixelPositionArray, uint256 colorArray, bytes32 communityName, uint256 timestamp);
     ...
     */
      ...
      */
     function buyPixels(uint256[] memory pixelPositionArray, uint256[] memory colorArray) payable public returns(bool){
     ...
     function pickWinner() public onlyOwner returns(bool){
         ...
         pixelDimensionToUsersTemp = new uint256[](0);
    ...
    //**********************************************//
      ...
      */
     function viewPixelOwner(uint256 pixelDimension) public view returns(address){
