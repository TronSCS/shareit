...
contract PlaceIt is owned, TokenTR20 {
    ...
    mapping(uint32=>address) pixelDimensionToUsers;    //Mapping for pixes dimension to users
    mapping(uint32=>address) pixelColorToUsers;        //Mapping for pixes color to users
    ...
    uint32[] internal pixelDimensionToUsersTemp;       //Temporary Array which holds all the pixels dimension purchased
    ...
    event PixelPurchased(address indexed byer, uint32 pixelPositionArray, uint32 colorArray, bytes32 communityName, uint256 timestamp);
     ...
     */
      ...
      */
     function buyPixels(uint32[] memory pixelPositionArray, uint32[] memory colorArray) payable public returns(bool){
     ...
     function pickWinner() public onlyOwner returns(bool){
         ...
         pixelDimensionToUsersTemp = new uint32[](0);
    ...
    //**********************************************//
      ...
      */
     function viewPixelOwner(uint32 pixelDimension) public view returns(address){
