...
contract PlaceIt is owned, TokenTR20 {
    ...
    mapping(bytes6=>address) pixelDimensionToUsers;     //Mapping for pixes dimension to users
    ...
    bytes6[] internal pixelDimensionToUsersTemp;        //Temporary Array which holds all the pixels dimension purchased
     ...
     */
      ...
      */
     function buyPixels(bytes6[] memory pixelPositionArray) payable public returns(bool){
    ...
    //**********************************************//
      ...
      */
     function viewPixelOwner(bytes6 pixelDimension) public view returns(address){
         return pixelDimensionToUsers[pixelDimension];
     }
     
    /**
    * Returns all the pixel dimensions as bytes6 array
    */
     function viewALLPixelDimensions() public view returns(bytes6[]){
