...
/* Mapping to track referrer. The second address is the address of referrer, the Up-line/ Sponsor */
    ...
    */
    ...
    function roll(uint _startNumber,uint _endNumber,uint _amount, bytes32 _seed, address _referrer, string _sideBet, uint256 _sideBetvalue) payable public returns(bool, uint256, bool, uint256) {
            ...
            bytes memory mintTokenData = abi.encodeWithSignature("mintToken(address,uint256)",msg.sender,msg.value);
            require(topiaTokenContractAddress.call.gas(200000)(mintTokenData), 'MintToken function did not work');
