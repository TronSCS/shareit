...
contract TopiaToken is owned {
    ...
    */
    ...
    function updateWhitelistAddress(address _newAddress, bool _status) public onlyOwner returns(string){
        
        require(_newAddress != address(0), 'Invalid Address');

        whitelistCaller[_newAddress] = _status;
        whitelistCallerArray.push(_newAddress);

        return "Whitelisting Address updated";
    }
