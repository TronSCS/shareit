...
contract TRONtopia_ultimate_dice is owned{
    ...
    uint256 private sideBetNetWin;
    uint256 private mainBetNetWin;
    ...
    * 
    */
    function roll(uint256[] rollIntegerVariables, bytes32[] memory rollBytes32Variables, address _referrer) payable public returns(bool) {
        ...
        if(rollBytes32Variables[2] != bytes32(0)){
            ...
            if( rollBytes32Variables[2] == _yin ){
                ...
                if(firstNumber>lastNumber){
                    ...
                    sideBetNetWin = sideBetsWin - (rollIntegerVariables[3] * 1e6);
                }        
            }
        ...
        if(sideBetNetWin + mainBetNetWin > address(this).balance / maxWinDivisibleAmount) return false;
