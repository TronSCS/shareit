...
contract TRONtopia_ultimate_dice is owned{
    ...
    */
    ...
    function updateSideBetJackpot (uint256 _sideBetJackpotAmount, uint256 _sideBetJackpotMaxOdd, uint256 _sideBetJackpotFixNumber) public onlyOwner returns(bool){
