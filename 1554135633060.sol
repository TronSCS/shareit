...
contract TRONtopia_ultimate_dice is owned{
    ...
    */
    function roll(uint256[] rollIntegerVariables, bytes32 _seedPlayer,  address _referrer) payable public {
        ...
        //checking conditions
        require(rollIntegerVariables[3] >= 25 && rollIntegerVariables[2] >= 10, 'Invalid sidebet and main bet value');
        require(msg.value == (rollIntegerVariables[2]+rollIntegerVariables[3]) * 1e6, 'Invalid _amount');
    ...
    */
    function randomForSidebetJackpot() internal returns (bool) {
