...
contract TopiaToken is owned {
    ...
    */
    ...
    function mintToken(address _user, uint256 _tronAmount)  public returns(bool) {
        ...
        */
        ...
        //Ideally we should emit Transfer event as well. but for the energy cost saving, just avoided.
    ...
    */
    function claimOwnerTokens() public onlyOwner returns (string){
...
46903153
    ...
    */
    function distributeMainDividend() public  returns(uint256){
        ...
        //owner can call this function anytime 
