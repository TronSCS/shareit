...
contract Jackpot is Ownable {
  ...
  function() payable {
    ...
    uint256 numberOfTickets = sunAmount/1e6;
    ...
    contributions[msg.sender] = contributions[msg.sender].add(sunAmount);

    newContribution(msg.sender, sunAmount);
