    ...
    function distributeMainDividend() public  returns(uint256){
        ...
        for(uint i=0; i < totalGameContracts; i++){
            ...
            if(status){
                ...
                uint256 bronzrTierAmount = amount / totalTopiaFrozen * bronzeTopiaAllUsers * 75 / 100;
                //silver tier
                uint256 silverTierAmount = amount / totalTopiaFrozen * silverTopiaAllUsers * 85 / 100;
                //gold tier
                uint256 goldTierAmount = amount / totalTopiaFrozen * goldTopiaAllUsers;
