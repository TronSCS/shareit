    ...
    function distributeMainDividend() public  returns(uint256){
        ...
        for(uint i=0; i < totalGameContracts; i++){
            ...
            if(status){
                ...
                uint256 bronzrTierAmount = amount  * 75 / 100 * bronzeTopiaAllUsers / totalTopiaFrozen;
                //silver tier
                uint256 silverTierAmount = amount  * 85 / 100 * silverTopiaAllUsers / totalTopiaFrozen;
                //gold tier
                uint256 goldTierAmount = amount  * goldTopiaAllUsers / totalTopiaFrozen;
